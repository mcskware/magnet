...
execute store result score #ipx magnet run data get entity @e[type=item,limit=1,sort=nearest] Pos[0] 1000
execute store result score #ipy magnet run data get entity @e[type=item,limit=1,sort=nearest] Pos[1] 1000
execute store result score #ipz magnet run data get entity @e[type=item,limit=1,sort=nearest] Pos[2] 1000

# get velocity of nearest item
execute store result score #ivx magnet run data get entity @e[type=item,limit=1,sort=nearest] Motion[0] 1000
execute store result score #ivy magnet run data get entity @e[type=item,limit=1,sort=nearest] Motion[1] 1000
execute store result score #ivz magnet run data get entity @e[type=item,limit=1,sort=nearest] Motion[2] 1000
...
execute store result entity @e[type=item,limit=1,sort=nearest] Motion[0] double 0.001 run scoreboard players get #ivx magnet
execute store result entity @e[type=item,limit=1,sort=nearest] Motion[1] double 0.001 run scoreboard players get #ivy magnet
execute store result entity @e[type=item,limit=1,sort=nearest] Motion[2] double 0.001 run scoreboard players get #ivz magnet
